...
export function EditConfirmationDialog({
	...
	const [deleteSubsequent, setDeleteSubsequent] = useState(
		hasSubsequentMessages,
	);
				...
				<div className="space-y-4 py-4">
						...
						<div className="flex items-start space-x-3">
							<Checkbox
								...
								onCheckedChange={(checked) =>
									setDeleteSubsequent(checked as boolean)
								}
								disabled={isLoading}
							/>
							<div className="space-y-1">
								...
								<p className="text-xs text-muted-foreground">
									Delete all messages that came after this one to maintain
									conversation flow
								</p>
							</div>
						</div>
					...
					<div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-md p-3">
						<p className="text-xs text-blue-800 dark:text-blue-200">
							💡 Tip: Regenerating the AI response ensures the conversation
							stays coherent with your changes.
						</p>
					</div>
				</div>
