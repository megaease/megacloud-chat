...
export function Thinking() {
  return (
    <motion.div
      className="flex items-center justify-center gap-2 max-w-[150px] w-auto mx-auto py-1.5 px-3 rounded-full border border-primary/10 shadow-sm dark:border-primary/30 z-10 mb-4"
      style={{
