...
import { MessageEditor } from "../chat/message-editor";
import { ReasoningPart } from "../chat/reasoning-part";
import { FilePreviewDialog } from "@/components/ui/file-preview-dialog";
import { ToolInvocationPart } from "../chat/tool-invocation-part";
...
export function ArtifactChat(props: ArtifactChatProps) {
  // For now, this is a placeholder that renders individual messages
  // In the future, this could be expanded to include a full chat interface
  return (
    <div className={props.className}>
      {props.messages.map((message, index) => (
        <ChatMessage
          ...
          message={message}
          isLoading={
            props.status === "streaming" && index === props.messages.length - 1
          }
          isCompact={true}
