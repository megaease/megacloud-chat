...
function ArtifactActions({
  ...
  const {
    ...
    artifact.status !== "streaming" ? artifact.documentId : undefined
  );
      ...
      <div className="flex items-center justify-between px-4 py-3 min-h-[52px]">
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          <Button
            ...
            onClick={onClose}
            disabled={isDisabled}
            className="h-9 w-9 hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20 dark:hover:text-red-400 rounded-lg transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:hover:scale-100"
            title={tCommon("close")}
          >
            <X className="h-4 w-4" />
          </Button>
          ...
          {showChatButton && onChatToggle && (
            <Button
              ...
              disabled={isDisabled}
              className="h-9 w-9 hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-600 dark:hover:text-blue-400 rounded-lg transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:hover:scale-100"
        ...
        <div className="flex items-center gap-4 flex-1 min-w-0 px-6">
          ...
          {/* 版本选择器 */}
          {canSwitchVersions && versions.length > 0 && (
            <DropdownMenu>
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            {onFullscreen && (
              <Button
                ...
                disabled={isDisabled}
                className="h-9 w-9 hover:bg-blue-50 hover:text-blue-600 dark:hover:bg-blue-900/20 dark:hover:text-blue-400 rounded-lg transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:hover:scale-100"
                title={
                  isFullscreen
            ...
            <div className="flex items-center gap-3 flex-shrink-0 jus">
              ...
              <div className="flex items-center rounded-md overflow-hidden bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                <Button
                  ...
                  size="sm"
                  onClick={handleCopy}
                  disabled={isDisabled || (!content && !isTextKind)}
                  className={cn(
