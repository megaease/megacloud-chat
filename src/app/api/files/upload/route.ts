...
const ALL_SUPPORTED_TYPES: readonly string[] = [...SUPPORTED_IMAGE_TYPES, ...SUPPORTED_DOCUMENT_TYPES];
...
const FileSchema = z.object({
	file: z
		...
		.refine((file) => {
			...
			message: "File size should be less than 5MB for images or 10MB for PDF",
		})
